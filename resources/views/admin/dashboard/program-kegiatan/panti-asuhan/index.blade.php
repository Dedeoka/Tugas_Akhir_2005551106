        ...
        <div class="card">
            <div class="d-flex justify-content-between">
                <div class="m-3 quick-sand">
                    <h3>
                        Tabel Data Program Kegiatan Panti
                    </h3>
                </div>
                    ...
                    <table class="datatables-basic table border-top quick-sand" id="kategoriBarangTable">
                        <thead>
                            <tr>
                                ...
                                <th class="col-md-2 text-center fw-bold">Tanggal</th>
                                <th class="col-md-3 text-center fw-bold">Lokasi</th>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="pt-4 border-top">
                                        <div class="px-3">
                                            ...
                                            <div class="row px-3">
                                                @foreach ($data->eventImages as $image)
...
@section('scripts')
    @include('admin.dashboard.program-kegiatan.panti-asuhan.js.index');
@endsection
