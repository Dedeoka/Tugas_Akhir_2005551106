    ...
    $(document).ready(function() {
        ...
        function storeImage(id) {
            ...
            $('.imageStoreSubmit').click(function(e) {
                ...
                var url = `/dashboard/eventStoreImage/${id}`;
        ...
        function imageUpdate(id) {
            ...
            $('.imageUpdateSubmit').click(function(e) {
                ...
                var url = `/dashboard/eventUpdateImage/${id}`;
        ...
        function simpan() {
            ...
            $.ajax({
                url: "{{ route('program-kegiatan-panti.store') }}",
                type: 'POST',
                data: formData,
                cache: false,
                contentType: false,
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function deleteData(dataId) {
            ...
            fetch(`/dashboard/program-kegiatan-panti/${dataId}`, {
                    method: 'DELETE',
                    headers: {
