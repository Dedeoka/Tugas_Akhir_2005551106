        ...
        <div class="layout-container">
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li
                        class="menu-item {{ request()->is('admin/dashboard/profile') || request()->is('admin/dashboard/pengumuman') || request()->is('admin/dashboard/gallery') ? 'active open' : '' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons bx bx-building-house"></i>
                            <div data-i18n="Profile">Profile Panti</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item {{ request()->is('admin/dashboard/profile') ? 'active' : '' }}">
                                <a href="{{ route('profile-panti.index') }}" class="menu-link">
                                    <div data-i18n="CRM">Data Profile Panti</div>
                                </a>
                            </li>
                            <li class="menu-item {{ request()->is('admin/dashboard/pengumuman') ? 'active' : '' }}">
                                <a href="{{ route('pengumuman.index') }}" class="menu-link">
                                    <div data-i18n="Analytics">Pengumuman</div>
                                </a>
                            </li>
                            <li class="menu-item {{ request()->is('admin/dashboard/gallery') ? 'active' : '' }}">
                    ...
                    <li
                        class="menu-item {{ request()->is('admin/dashboard/program-kegiatan*') ? 'active open' : '' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <ul class="menu-sub">
                            <li
                                class="menu-item {{ request()->is('admin/dashboard/program-kegiatan-panti') ? 'active' : '' }}">
                                <a href="{{ route('program-kegiatan-panti.index') }}" class="menu-link">
                                    <div data-i18n="CRM">Data Program Kegiatan Panti Asuhan</div>
                                </a>
                            </li>
                            <li
                                class="menu-item {{ request()->is('admin/dashboard/program-kegiatan-donatur') ? 'active' : '' }}">
                    ...
                    <li class="menu-item {{ request()->is('admin/master-data/daftar-sekolah') ? 'active' : '' }}">
                        <a href="{{ route('daftar-sekolah.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bxs-school"></i>
                            <div data-i18n="Email">Daftar Sekolah</div>
                        </a>
                    </li>
                    <li class="menu-item {{ request()->is('admin/master-data/kategori-barang') ? 'active' : '' }}">
                    ...
                    <li class="menu-item {{ request()->is('admin/master-data/kategori-pemasukan') ? 'active' : '' }}">
                    ...
                    <li
                        class="menu-item {{ request()->is('admin/master-data/kategori-pengeluaran') ? 'active' : '' }}">
                        <a href="{{ route('kategori-pengeluaran.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bxs-category-alt"></i>
                            <div data-i18n="Email">Kategori Pengeluaran</div>
                        </a>
                    </li>
                    <li class="menu-item {{ request()->is('admin/master-data/kategori-penyakit') ? 'active' : '' }}">
                    ...
                    <li class="menu-item {{ request()->is('admin/master-data/kategori-program') ? 'active' : '' }}">
                    ...
                    <li class="menu-item {{ request()->is('admin/donasi/donasi-uang') ? 'active' : '' }}">
                        <a href="{{ route('donasi-uang.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-money"></i>
                            <div data-i18n="Basic">Donasi Uang</div>
                        </a>
                    </li>
                    <li class="menu-item {{ request()->is('admin/donasi/donasi-barang') ? 'active' : '' }}">
                        <a href="{{ route('donasi-barang.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-donate-heart"></i>
                            <div data-i18n="Basic">Donasi Barang</div>
                        </a>
                    </li>
                    <li class="menu-item {{ request()->is('admin/donasi/donasi-beasiswa') ? 'active' : '' }}">
                    ...
                    <li class="menu-item {{ request()->is('admin/keuangan/statistik-keuangan') ? 'active' : '' }}">
                        <a href="{{ route('statistik-keuangan.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-bar-chart"></i>
                            <div data-i18n="Tables">Statistik Keuangan</div>
                        </a>
                    </li>
                    <li class="menu-item {{ request()->is('admin/keuangan/pemasukan-panti') ? 'active' : '' }}">
                    ...
                    <li class="menu-item {{ request()->is('admin/keuangan/pengeluaran*') ? 'active open' : '' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <ul class="menu-sub">
                            <li
                                class="menu-item {{ request()->is('admin/keuangan/pengeluaran-total') ? 'active' : '' }}">
                                <a href="{{ route('pengeluaran-total.index') }}" class="menu-link">
                                    <div data-i18n="CRM">Data Pengeluaran Total</div>
                                </a>
                            </li>
                            <li
                                class="menu-item {{ request()->is('admin/keuangan/pengeluaran-anak') ? 'active' : '' }}">
                                <a href="{{ route('pengeluaran-anak.index') }}" class="menu-link">
                                    <div data-i18n="CRM">Pengeluaran Anak Asuh</div>
                                </a>
                            </li>
                            <li
                                class="menu-item {{ request()->is('admin/keuangan/pengeluaran-panti') ? 'active' : '' }}">
                    ...
                    <li
                        class="menu-item {{ request()->is('admin/keuangan/laporan-keuangan*') || request()->is('admin/keuangan/neraca-keuangan*') ? 'active open' : '' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <ul class="menu-sub">
                            <li
                                class="menu-item {{ request()->is('admin/keuangan/laporan-keuangan-bulanan') || request()->is('keuangan/neraca-keuangan-bulanan') ? 'active' : '' }}">
                                <a href="{{ route('laporan-keuangan.bulanan') }}" class="menu-link">
                                    <div data-i18n="CRM">Laporan Bulanan</div>
                                </a>
                            </li>
                            <li
                                class="menu-item {{ request()->is('admin/keuangan/laporan-keuangan-tahunan') || request()->is('admin/keuangan/neraca-keuangan-tahunan') ? 'active' : '' }}">
                    ...
                    <li class="menu-item {{ request()->is('admin/anak-asuh/data-anak') ? 'active' : '' }}">
                    ...
                    <li class="menu-item {{ request()->is('admin/anak-asuh/pendidikan-anak') ? 'active' : '' }}">
                        <a href="{{ route('pendidikan-anak.index') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bxs-school"></i>
                            <div data-i18n="Documentation">Pendidikan Anak Asuh</div>
                        </a>
                    </li>
                    <li class="menu-item {{ request()->is('admin/anak-asuh/kesehatan-anak') ? 'active' : '' }}">
                    ...
                    <li class="menu-item {{ request()->is('admin/anak-asuh/prestasi*') ? 'active open' : '' }}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                        ...
                        <ul class="menu-sub">
                            <li
                                class="menu-item {{ request()->is('admin/anak-asuh/prestasi-anak') ? 'active' : '' }}">
                                <a href="{{ route('prestasi-anak.index') }}" class="menu-link">
                                    <div data-i18n="Documentation">Prestasi Anak Asuh</div>
                                </a>
                            </li>
                            <li
                                class="menu-item {{ request()->is('admin/anak-asuh/prestasi-akademik-anak') ? 'active' : '' }}">
